...
def main():
  ...
  while cap.isOpened():
      ...
      for annotation in annotations:
        ...
        if(annotation.confidence_score>0.50):
          ...
          if(annotation.class_name=="dominada"):
            ...
            try:
            	playsound("/home/mendel/dominadas-autoML/automl-videoOnDevice/examples/referee.mp3")
    ...
    #frame = cv2.putText(frame, '{} ms'.format(latency), (0, 40),
                        #cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 255, 0), 2)
    frame = cv2.putText(frame, ('Dominadas:'+str(dominadaCount)), (0, 66),
